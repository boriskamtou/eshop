...
class _EmailPasswordSignInContentsState
  ...
  Future<void> _submit(EmailPasswordSignInState state) async {
    ...
    if (_formKey.currentState!.validate()) {
      final controller = ref.read(
          emailPasswordSignControllerNotifierProvider(widget.formType)
              .notifier);
  ...
  void _updateFormType(EmailPasswordSignInFormType formType) {
    ...
    ref
        .watch(emailPasswordSignControllerNotifierProvider(widget.formType)
            .notifier)
  ...
  Widget build(BuildContext context) {
    ...
    final state =
        ref.watch(emailPasswordSignControllerNotifierProvider(widget.formType));
